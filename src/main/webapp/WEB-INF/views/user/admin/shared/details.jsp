...
=======
        ...
        &emsp;
        <a href="${contextRoot}/adm/receiveapayment/${user.id}" class="btn btn-primary"> Receive A Payment</a>
        <a href="${contextRoot}/report/payment_report/${user.id}" class="btn btn-primary"> Payment Report</a>
>>>>>>> 7619d62... first commit
    </form:form>
...
<c:if test="${gototeachers == true}">
    ...
    <form:form action="${contextRoot}/adm/findateacher/${user.id}" method="post" modelAttribute="teacher">
        <a href="${contextRoot}/adm/gototeachers/${user.id}" class="btn btn-primary"> View All Teacher</a>
        <a href="${contextRoot}/adm/gotoaddteacher/${user.id}" class="btn btn-primary"> Add A Teacher</a>

        &emsp; &emsp; &emsp;
        <span class="btn btn-primary"> Search Teacher</span> 
        ...
        <c:forEach var="t" items="${tList}"> 
            ...
            <tr class="pro3">
                ...
                <td class="pro3" style="padding-top: 5px; padding-bottom: 5px " > 
                    <a href="${contextRoot}/adm/gotoupdateteacher/${user.id}/${t.id}" class="btn btn-primary"> Update</a>
                    <a href="${contextRoot}/adm/deleteteacher/${user.id}/${t.id}" class="btn btn-primary"> Delete</a>
                </td>
...
<c:if test="${AddTeacherForm == true}">
    ...
    <center> <br/>
        <span class="btn btn-primary"> Add Teacher Form 
        </span>   </center><br/>
...
<c:if test="${TeacherUpdateForm == true}">
    ...
    <center> <br/>
        <span class="btn btn-primary">  Teacher Information Update Form 
        </span>   </center><br/>
        ...
        <div class="col-md-6"> 
            ...
            <form:form action="${contextRoot}/adm/updateteacher/${user.id}"  method="post" modelAttribute="teacher"   >
                ...
                <form:label class=" form-group" path="dept_id">Department ID : </form:label>
                    ...
                    <div >
                    <form:input class="form-control" value="${td.dept_id}"  path="dept_id" required="true" placeholder=" Department ID" /> 
                </div> 
                <br/>
...
<c:if test="${TeacherSearchResult == true}" > 
    ...
    <table style="width: 80%">
        ...
        <tr>
            <td class="pro6" > DEPARTMENT ID   </td>
    ...
    <center>
        <a href="${contextRoot}/adm/gotoupdateteacher/${user.id}/${td.id}" class="btn btn-primary"> Update</a> &emsp;&emsp;
        <a href="${contextRoot}/adm/deleteteacher/${user.id}/${td.id}" class="btn btn-primary"> Delete</a>
    </center>
...
<c:if test="${gotostudents == true}">
    ...
    <form:form action="${contextRoot}/adm/findastudent/${user.id}" method="post" modelAttribute="student">
        <a href="${contextRoot}/adm/gotostudents/${user.id}" class="btn btn-primary"> View All Student</a>
        <a href="${contextRoot}/adm/gotoaddstudent/${user.id}" class="btn btn-primary"> Add A Student</a>

        &emsp; &emsp; &emsp;
        <span class="btn btn-primary"> Search Student</span> 
    ...
    <table id="count_it" style="width: 80%">
        ...
        <c:forEach var="s" items="${sList}"> 
            ...
            <tr class="pro3">
                ...
                <td class="pro3" style="padding-top: 5px; padding-bottom: 5px " > 
                    <a href="${contextRoot}/adm/gotoupdatestudent/${user.id}/${s.id}" class="btn btn-primary"> Update</a>
                    <a href="${contextRoot}/adm/deletestudent/${user.id}/${s.id}" class="btn btn-primary"> Delete</a>
                </td>
...
<c:if test="${AddStudentForm == true}">
    ...
    <center> <br/>
        <span class="btn btn-primary">  Student Add Form 
        </span>   </center><br/>
...
<c:if test="${StudentUpdateForm == true}">
    ...
    <form:form action="${contextRoot}/adm/findateacher/${user.id}" method="post" modelAttribute="student">
        <a href="${contextRoot}/adm/gotostudents/${user.id}" class="btn btn-primary"> View All Teacher</a>
        <a href="${contextRoot}/adm/gotoaddstudent/${user.id}" class="btn btn-primary"> Add A Teacher</a>
        ...
        <div class="col-md-6"> 
            ...
            <form:form action="${contextRoot}/adm/updatestudent/${user.id}"  method="post" modelAttribute="student"   >
                ...
                <form:label class=" form-group" path="address">Contact Number  : </form:label>
                    ...
                    <div><form:input style="width:70%; font-weight:bold" class="form" value=" ${sd.contact_no}"  type=""  path="contact_no" required="true" placeholder="Contact Number"/> 
                </div>
                <br/>
                <form:label class=" form-group" path="email">Email Address : </form:label>
                ...
                <form:label class=" form-group" path="dept_id">Department ID : </form:label>
                <div >      <form:input class="form-control" value="${sd.dept_id}"  path="dept_id" required="true" placeholder=" Department ID" /> 
                </div>           <br/>
                <center>                    <span>
                        <form:button type="submit" class="btn btn-primary ">Submit</form:button>
                        </span>                    </center> 
...
<c:if test="${StudentSearchResult == true}" > 
    ...
    <center>
        <a href="${contextRoot}/adm/gotoupdatestudent/${user.id}/${sd.id}" class="btn btn-primary"> Update</a> &emsp;&emsp;
        <a href="${contextRoot}/adm/deletestudent/${user.id}/${sd.id}" class="btn btn-primary"> Delete</a>
    </center>
...
<c:if test="${gotodepartments == true}">
    ...
    <form:form action="${contextRoot}/adm/findadepartment/${user.id}" method="post" modelAttribute="department">
        <a href="${contextRoot}/adm/gotodepartments/${user.id}" class="btn btn-primary"> View All Department</a>
        <a href="${contextRoot}/adm/gotoadddepartment/${user.id}" class="btn btn-primary"> Add A Department</a>

        &emsp; &emsp; &emsp;
        <span class="btn btn-primary"> Search Department</span> 
        <form:input type="number" path="id" placeholder="Type Department ID" />
        <button class="btn btn-primary" >Submit</button> 
        &emsp;
    </form:form> 
    <br/>
    ...
    <table id="count_it" style="width: 80%">
        ...
        <tr class="pro5" style="text-align: center">
            <td class="pro5" style="text-align: center"> Department ID    </td>
            <td class="pro5"  style="text-align: center"> Department Name    </td>
        ...
        <c:forEach var="d" items="${dlist}"> 
            ...
            <tr class="pro3" >
                ...
                <td class="pro3" style="padding-top: 5px; padding-bottom: 5px " > 
                    <a href="${contextRoot}/adm/gotoupdatedepartment/${user.id}/${d.id}" class="btn btn-primary"> Update</a>
                    <a href="${contextRoot}/adm/deletedepartment/${user.id}/${d.id}" class="btn btn-primary"> Delete</a>
                </td>
...
<c:if test="${DepartmentSearchResult == true}">
    ...
    <table style="width: 80%">
        ...
        <tr>
            <td class="pro6" > Department Name    </td>
    ...
    <center>
        <a href="${contextRoot}/adm/gotoupdatedepartment/${user.id}/${dd.id}" class="btn btn-primary"> Update</a>
        <a href="${contextRoot}/adm/deletedepartment/${user.id}/${dd.id}" class="btn btn-primary"> Delete</a>
    </center>
...
<c:if test="${AddDepartmentForm == true}">
    ...
    <center> <br/>
        <span class="btn btn-primary">  Department Add Form 
        </span>   </center><br/>
    ...
    <div class="row">
        ...
        <div class="col-md-6"> 
            ...
            <form:form action="${contextRoot}/adm/adddepartment/${user.id}"  method="post" modelAttribute="department"   >
                ...
                <br/> <form:label class=" form-group" path="dept_name">Department Name  : </form:label>
                    <div>
                    <form:input  class="form-control"   path="dept_name" placeholder="Department Name" required="true" /> 
                </div> <br/>
                <center>                    <span>
                        <form:button type="submit" class="btn btn-primary ">Submit</form:button>
                        </span>                    </center> 
...
<c:if test="${DepartmentUpdateForm == true}">
    ...
    <center> <br/>
        <span class="btn btn-primary">  Department Information Update Form 
        </span>   </center><br/>
    ...
    <div class="row">
        ...
        <div class="col-md-6"> 
            ...
            <form:form action="${contextRoot}/adm/updatedepartment/${user.id}"  method="post" modelAttribute="department"   >
                ...
                <br/> <form:label class=" form-group" path="id">Department ID  : </form:label>
                    <div>
                    <form:input  class="form-control" value="${dd.id}"  readonly="true"  path="id" placeholder="Department ID" required="true" /> 
                </div>
                <br/> <form:label class=" form-group" path="dept_name">Department Name  : </form:label>
                    <div>
                    <form:input  class="form-control"   value="${dd.dept_name}"  path="dept_name" placeholder="Department Name" required="true" /> 
                </div>
...
<c:if test="${gotoschedule == true }">
    ...
    <form:form action="${contextRoot}/adm/findschedule/${user.id}" method="post" modelAttribute="schedule">
        <a href="${contextRoot}/adm/gotoschedule/${user.id}" class="btn btn-primary"> View All Class Schedules</a>
        <a href="${contextRoot}/adm/gotoaddschedule/${user.id}" class="btn btn-primary"> Add A Class Schedule</a>

        &emsp; &emsp; &emsp;
        <span class="btn btn-primary"> Search Schedule</span> 
        <form:input  path="dept_id" placeholder="Department ID ( number )" />
        <button class="btn btn-primary" >Submit</button> 
        &emsp;
    </form:form>  
    <center>
    ...
    <table id="count_it" style="width: 80%">
        ...
        <c:forEach var="c" items="${clist}"> 
            ...
            <tr class="pro3">
                ...
                <td class="pro3" style="padding-top: 5px; padding-bottom: 5px " > 
                    <a href="${contextRoot}/adm/gotoupdateschedule/${user.id}/${c.id}" class="btn btn-primary"> Update</a>
                    <a href="${contextRoot}/adm/deleteschedule/${user.id}/${c.id}" class="btn btn-primary"> Delete</a>
                </td>
...
<c:if test="${ScheduleUpdateForm == true}">
    ...
    <center> <br/>
        <span class="btn btn-primary">  Schedule Information Update Form 
        </span>   </center><br/>
        ...
        <div class="col-md-6"> 
            ...
            <form:form action="${contextRoot}/adm/updateschedule/${user.id}"  method="post" modelAttribute="schedule"   >
                ...
                <form:label class=" form-group"  path="dept_id">DEPARTMENT ID  : </form:label>
                    ...
                    <div >
                    <form:input class="form-control" type="number"  path="dept_id" required="true" placeholder="DEPARTMENT ID" value="${cd.dept_id}" /> 
                </div> 
                <br/>

                <form:label class="form-group" path="course_id">COURSE ID  : </form:label>

                    <div >
                    <form:input class="form-control"   type="number" value="${cd.course_id}" path="course_id" required="true" placeholder="COURSE ID"/> 
                </div> 
                <br/>
...
<c:if test="${AddScheduleForm == true}">
    ...
    <form:form action="${contextRoot}/adm/findschedule/${user.id}" method="post" modelAttribute="schedule">
        ...
        &emsp; &emsp; &emsp;
        <span class="btn btn-primary"> Search Schedule</span> 
        <form:input type="number"  path="dept_id" placeholder="Department ID ( number )" />
        <button class="btn btn-primary" >Submit</button> 
        &emsp;
    </form:form> 

    <center> <br/>
        <span class="btn btn-primary">  Schedule Add Form 
        </span>   </center><br/>
        ...
        <div class="col-md-6"> 
            ...
            <form:form action="${contextRoot}/adm/addschedule/${user.id}"  method="post" modelAttribute="schedule"   >
                ...
                <form:label class=" form-group" path="dept_id">DEPARTMENT ID  : </form:label>
                    ...
                    <div >
                    <form:input class="form-control" type="number"  path="dept_id" required="true" placeholder="DEPARTMENT ID"/> 
                </div> 
                <br/>
...
<c:if test="${ScheduleSearchResult == true}">
    ...
    <center>
        <a href="${contextRoot}/adm/gotoupdateschedule/${user.id}/${cd.id}" class="btn btn-primary"> Update</a>
        <a href="${contextRoot}/adm/deleteschedule/${user.id}/${cd.id}" class="btn btn-primary"> Delete</a>
    </center>
...
<c:if test="${gotonotice == true}"> 
    ...
    <form:form action="${contextRoot}/dispatch/findnotice/${user.id}" method="post" modelAttribute="notice">
        <a href="${contextRoot}/dispatch/gotonotice/${user.id}" class="btn btn-primary"> View All Notices</a>
        <a href="${contextRoot}/dispatch/gotoaddnotice/${user.id}" class="btn btn-primary"> Add A Notice</a>
        ...
        <c:forEach var="n" items="${nlist}"> 
            ...
            <tr class="pro3">
                ...
                <td class="pro3" style="width:10%; padding-top: 5px; padding-bottom: 5px " > 
                    <a href="${contextRoot}/dispatch/gotoupdatenotice/${user.id}/${n.id}" class="btn btn-primary"> Update</a>
                    <a href="${contextRoot}/dispatch/deletenotice/${user.id}/${n.id}" class="btn btn-primary"> Delete</a>
                </td>
...
<c:if test="${gotaddonoticeform == true}"> 
    ...
    <center> <br/>
        <span class="btn btn-primary">  Notice, News & Event Add Form 
        </span>   </center><br/>
...
<c:if test="${gotoupdatenoticeform == true}">
    ...
    <center> <br/>
        <span class="btn btn-primary"> ${nd.type} Information Update Form 
        </span>   </center><br/>
    ...
    <div class="row">
        ...
        <div class="col-md-6"> 
            ...
            <form:form action="${contextRoot}/dispatch/updatenotice/${user.id}"  method="post" modelAttribute="notice"   >
                <form:label class=" form-group" path="id">ID  : </form:label>
                ...
                <div >
                    <form:textarea class="form-control" value="${nd.body}"   path="body" required="true" placeholder="Main Body "/> 
                </div> 
                <br/>
...
<c:if test="${gotoinbox == true}">    
    ...
    <form:form action="${contextRoot}/dispatch/findapplication/${user.id}" method="post" modelAttribute="application">
        <a href="${contextRoot}/dispatch/gotoinbox/${user.id}" class="btn btn-primary"> View All Application</a>
    ...
    <table id="count_it" style="width: 80%">
        ...
        <c:forEach var="ap" items="${aplist}"> 
            ...
            <tr class="pro3">
                ...
                <td class="pro3" style="width:10%; padding-top: 5px; padding-bottom: 5px " > 
                    <a href="${contextRoot}/dispatch/deleteapplication/${user.id}/${ap.a_id}" class="btn btn-primary"> Delete</a>
                </td>
...
<c:if test="${showReport == true}"  > 
    <%@include file="report_page.jsp"  %>

</c:if>
        
        
<c:if test="${resultPanel==true}"  > 
    <%@include file="resultSheet.jsp"  %>
